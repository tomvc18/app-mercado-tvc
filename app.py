...
app = dash.Dash(external_stylesheets=[dbc.themes.BOOTSTRAP], title='Información Mercado')
server = app.server
suppress_callback_exceptions = True

from funciones import ultDiaHabil, get_TRM, get_data, get_TRM_BoxPlot, trm_table_yr, df_stocks, get_OIL
